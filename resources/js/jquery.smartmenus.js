                    ...
                    [
                        [
                            ...
                            function(e) {
                                ...
                                if (lastMove) {
                                    var deltaX = Math.abs(
                                            lastMove.x - thisMove.x
                                        ),
                                        deltaY = Math.abs(
                                            lastMove.y - thisMove.y
                                        );
                                    if (
                                        (deltaX > 0 || deltaY > 0) &&
                                        deltaX <= 2 &&
        ...
        prototype: {
                        ...
                        .bind(
                            getEventsNS(
                                [
                                    [
                                        "mouseover focusin",
                                        $.proxy(this.rootOver, this)
                                    ],
                                    [
                                        "mouseout focusout",
                                        $.proxy(this.rootOut, this)
                                    ],
                        ...
                        .delegate(
                            ...
                            getEventsNS(
                                [
                                    [
                                        "mouseenter",
                                        $.proxy(this.itemEnter, this)
                                    ],
                                    [
                                        "mouseleave",
                                        $.proxy(this.itemLeave, this)
                                    ],
                        ...
                        $(document).bind(
                            getEventsNS(
                                [
                                    [
                                        "touchstart",
                                        $.proxy(this.docTouchStart, this)
                                    ],
                                    [
                                        "touchmove",
                                        $.proxy(this.docTouchMove, this)
                                    ],
                                    [
                                        "touchend",
                                        $.proxy(this.docTouchEnd, this)
                                    ],
            ...
            itemActivate: function($a, focus) {
                ...
                if (
                    $sub &&
                    (this.isTouchMode() ||
                        !this.opts.showOnClick || this.clickActivated)
                ) {
                    this.menuShow($sub);
                }
            },
            ...
            menuScroll: function($sub, once, step) {
                ...
                data.y =
                    (data.up && end <= data.y) || (!data.up && end >= data.y)
                        ...
                        : end;
                $sub.add($sub.dataSM("ie-shim")).css(
                    this.cssTransforms3d
                        ? {
                              "-webkit-transform":
